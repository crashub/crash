 ...
 * @version $Revision$
 */
public abstract class AbstractInputDecoderTestCase extends TestCase {
  ...
  public void testMoveLeftInsert() throws IOException {
    ...
    sm.appendData("b\n");
    assertTrue(sm.hasNext());
    assertEquals(new Input.Chars(getExpectedMoveLeftInsert()), sm.next());
    assertFalse(sm.hasNext());
  }
  ...
  public void testMoveLeftDel() throws IOException {
    ...
    sm.appendData("\n");
    assertTrue(sm.hasNext());
    assertEquals(new Input.Chars(getExpectedMoveLeftDel()), sm.next());
    assertFalse(sm.hasNext());
  }
  ...
  public void testMoveRightInsert() throws IOException {
    ...
    sm.appendData("d\n");
    assertTrue(sm.hasNext());
    assertEquals(new Input.Chars(getExpectedMoveRightInsert()), sm.next());
    assertFalse(sm.hasNext());
  }
  ...
  public void testMoveRightDel() throws IOException {
    ...
    sm.appendData("\n");
    assertTrue(sm.hasNext());
    assertEquals(new Input.Chars(getExpectedMoveRightDel()), sm.next());
    assertFalse(sm.hasNext());
  }
  ...
  public void testMoveRightAtEndOfLine() throws IOException {
    ...
    sm.appendData("b\n");
    assertTrue(sm.hasNext());
    assertEquals(new Input.Chars(getExpectedMoveRightAtEndOfLine()), sm.next());
    assertFalse(sm.hasNext());
  }
