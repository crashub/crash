...
public class ParserTestCase extends TestCase {
  ...
  public void testCommand() {
    ...
    assertEquals(Arrays.asList("a"), e.term.chunks);
  ...
  public void testPlus() {
    ...
    AST.Expr e = (AST.Expr)p.parse();
    assertEquals(Arrays.asList("a"), e.term.chunks);
    assertEquals(Arrays.asList("b"), e.term.next.chunks);
  ...
  public void testPipe() {
    ...
    assertEquals(Arrays.asList("a"), e.term.chunks);
    assertNull(e.term.next);
    assertEquals(Arrays.asList("b"), e.next.term.chunks);
  ...
  public void testComplex() {
    ...
    assertEquals(Arrays.asList("b"), e.term.next.chunks);
    assertNull(e.term.next.next);
    assertEquals(Arrays.asList("c"), e.next.term.chunks);
    assertNull(e.next.next);
  }
