...
public class CRaSH2 {
  ...
  /** . */
  private static Logger log = Logger.getLogger(CRaSH2.class.getName());

  /** . */
  private final CommandDescriptor<CRaSH2> descriptor;

  public CRaSH2() throws IntrospectionException {
    this.descriptor = CommandFactory.DEFAULT.create(CRaSH2.class);
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    //
    CRaSH2 main = new CRaSH2();
    InvocationMatcher<CRaSH2> matcher = main.descriptor.matcher("main");
    InvocationMatch<CRaSH2> match = matcher.parse(line.toString());
    match.invoke(new CRaSH2());
  }
}
