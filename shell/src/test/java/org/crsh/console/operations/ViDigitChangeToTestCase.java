 ...
 * @author Julien Viet
 */
public class ViDigitChangeToTestCase extends AbstractConsoleTestCase {
  ...
  public void testMoveLeft6() throws Exception {
    ...
    console.on(Operation.SELF_INSERT, '_');
    console.on(Operation.SELF_INSERT, 'H');
    console.on(Operation.SELF_INSERT, 'I');
    assertEquals("0123456789ABCDEFHIJL_HIZ", getCurrentLine());
  }
  ...
  public void testMoveLeft7() throws Exception {
    ...
    console.on(Operation.VI_CHANGE_TO);
    console.on(Operation.BACKWARD_CHAR);
    console.on(Operation.SELF_INSERT, 'X');
    assertEquals("woXd", getCurrentLine());
  }
}
