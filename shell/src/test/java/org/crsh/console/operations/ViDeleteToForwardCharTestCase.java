 ...
 * @author Julien Viet
 */
public class ViDeleteToForwardCharTestCase extends AbstractConsoleTestCase {

  // Delete move right
  public void testMoveRight4() throws Exception {
    console.init();
    console.toInsert();
    ...
    console.on(Operation.VI_DELETE_TO);
    console.on(Operation.FORWARD_CHAR);
    assertEquals("bunch of words", getCurrentLine());
  }
}
