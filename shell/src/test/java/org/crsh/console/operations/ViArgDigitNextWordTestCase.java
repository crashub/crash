 ...
 * @author Julien Viet
 */
public class ViArgDigitNextWordTestCase extends AbstractConsoleTestCase {

  public void testWordRight3() throws Exception {
    console.toInsert();
    console.init();
    console.on(KeyEvent.of("a big batch of buttery frog livers"));
